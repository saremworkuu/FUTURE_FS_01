  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none opacity-0 animate-[fadeIn_3s_ease-out_forwards] z-0">
        <div className="relative w-full h-full flex justify-center">
          <img 
            ...
            className="w-full max-w-7xl h-full object-cover object-center grayscale brightness-[0.2] dark:brightness-[0.3] contrast-[1.15] [mask-image:linear-gradient(to_bottom,black_0%,black_40%,transparent_90%)]"
            loading="lazy"
          />
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 text-center flex flex-col items-center content-scale">
        ...
        <h1 className="font-serif text-7xl md:text-9xl lg:text-[11rem] leading-[0.85] mb-6 md:mb-8 tracking-tighter opacity-0 animate-[slideUp_1.5s_ease-out_forwards_0.2s] text-luxury-charcoal dark:text-luxury-beige">
          Sarendem <br />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] pointer-events-none opacity-40 dark:opacity-60 z-[-1]">
      ...
      <div className="absolute top-0 right-[20%] w-px h-screen bg-gradient-to-b from-transparent via-luxury-gold/20 to-transparent"></div>

      {/* Scroll indicator with text */}
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center opacity-40 transition-opacity hover:opacity-100 cursor-pointer group">
        <span className="text-[9px] uppercase tracking-[0.4em] mb-6 group-hover:text-luxury-gold transition-colors">Scroll</span>
